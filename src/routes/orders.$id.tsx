...
function OrderDetail() {
  ...
  if (isLoading) return <main className="mx-auto max-w-3xl px-6 py-16 text-cream/50">Loading…</main>;
  if (!order) return <main className="mx-auto max-w-3xl px-6 py-16">Order not found.</main>;
